            ...
            <div className="relative z-10 flex flex-col min-h-screen">
                ...
                <div className="flex-1 flex items-center justify-center px-4 py-12">
                    <div className="max-w-4xl w-full bg-gradient-to-br from-[#A1AFBA]/10 via-[#848160]/10 to-[#A365AD]/10 backdrop-blur-sm rounded-[20px] p-8 md:p-12 text-center text-white border border-white/20">
                        <h1 className="text-5xl md:text-6xl text-black font-semibold mb-6 leading-tight font-bricolage">
                            Garden Design Made Simple, <br />
                            Creative and Fun.
                        </h1>

                        <p className="text-xl md:text-2xl mb-8 max-w-2xl mx-auto drop-shadow-sm text-black">
