...
export default function Settings() {
    ...
    const [platformName, setPlatformName] = useState("Learning Management System");
            ...
            <div className="mx-auto">
                ...
                <div className="flex gap-8 mb-6 border-b border-gray-200">
                    <button
                        ...
                        className={`pb-3 text-sm font-semibold transition-colors relative ${activeTab === "general"
                                ? "text-gray-900"
                ...
                {activeTab === "general" && (
                    <div className="bg-white rounded-2xl shadow-sm border border-gray-100 p-8">
                        <div className="flex items-center gap-2 mb-2">
                            <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth={1.8} className="w-5 h-5 text-gray-700">
                                <path strokeLinecap="round" strokeLinejoin="round" d="M12 21a9.004 9.004 0 0 0 8.716-6.747M12 21a9.004 9.004 0 0 1-8.716-6.747M12 21c2.485 0 4.5-4.03 4.5-9S14.485 3 12 3m0 18c-2.485 0-4.5-4.03-4.5-9S9.515 3 12 3m0 0a8.997 8.997 0 0 1 7.843 4.582M12 3a8.997 8.997 0 0 0-7.843 4.582m15.686 0A11.953 11.953 0 0 1 12 10.5c-2.998 0-5.74-1.1-7.843-2.918m15.686 0A8.959 8.959 0 0 1 21 12c0 .778-.099 1.533-.284 2.253m0 0A17.919 17.919 0 0 1 12 16.5c-3.162 0-6.133-.815-8.716-2.247m0 0A9.015 9.015 0 0 1 3 12c0-1.605.42-3.113 1.157-4.418" />
                            </svg>
                            <h2 className="text-base font-bold text-gray-900">Platform Information</h2>
                        </div>
                        <p className="text-sm text-gray-500 mb-6">Basic configuration for your platform</p>
                        ...
                        <div className="flex items-center gap-4 mb-6">
                            ...
                            <div>
                                ...
                                <p className="text-xs text-gray-400 mt-1">Professional photo recommended (JPG, PNG - Max. 5MB)</p>
                            </div>
                        </div>
                    ...
                    <div className="bg-white rounded-2xl shadow-sm border border-gray-100 p-8">
                        <div className="flex items-start justify-between mb-6">
                            <div className="flex items-center gap-2">
                                ...
                                <h2 className="text-base font-semibold text-gray-500">Terms & Conditions</h2>
                            </div>
                            {!isEditingTerms && (
                                <button
                    ...
                    <div className="bg-white rounded-2xl shadow-sm border border-gray-100 p-8">
                        <div className="flex items-start justify-between mb-6">
                            <div className="flex items-center gap-2">
                                ...
                                <h2 className="text-base font-semibold text-gray-500">Privacy Policy</h2>
                            </div>
                            {!isEditingPrivacy && (
                                <button
