...
export default function AdminDashboard() {
  ...
  const getStats = () => {
    ...
    return [
      ...
      {
        label: "Active Today",
        value: dashboardStats.active_today?.toLocaleString() || "0",
        icon: (
          <svg
            viewBox="0 0 24 24"
            fill="none"
      ...
      },
      {
        ...
        value: dashboardStats.gardens_created?.toLocaleString() || "0",
        icon: (
          <svg
            viewBox="0 0 24 24"
            fill="none"
      ...
      //   value: dashboardStats.total_plants?.toLocaleString() || "0",
      //   icon: (
      //     <svg
      //       viewBox="0 0 24 24"
      //       fill="none"
