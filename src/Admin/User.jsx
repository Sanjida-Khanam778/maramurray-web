...
const initialUsers = [
    { id: 1, name: "John Doe", email: "john@email.com", avatar: "https://i.pravatar.cc/150?img=12", status: "Active", projects: 5, posts: 14, joined: "Jan 15, 2025", phone: "+1 (555) 123-4567", lastActive: "2 hours ago" },
    { id: 2, name: "Sarah Smith", email: "sarah@email.com", avatar: "https://i.pravatar.cc/150?img=47", status: "Active", projects: 5, posts: 14, joined: "Feb 20, 2025", phone: "+1 (555) 234-5678", lastActive: "5 hours ago" },
    { id: 3, name: "Michael Johnson", email: "michael@email.com", avatar: "https://i.pravatar.cc/150?img=33", status: "Active", projects: 5, posts: 14, joined: "Dec 5, 2024", phone: "+1 (555) 345-6789", lastActive: "1 day ago" },
    { id: 4, name: "Emily Brown", email: "emily@email.com", avatar: "https://i.pravatar.cc/150?img=25", status: "Inactive", projects: 5, posts: 14, joined: "Nov 12, 2024", phone: "+1 (555) 456-7890", lastActive: "1 week ago" },
    { id: 5, name: "David Wilson", email: "david@email.com", avatar: "https://i.pravatar.cc/150?img=68", status: "Active", projects: 5, posts: 14, joined: "Jan 28, 2025", phone: "+1 (555) 567-8901", lastActive: "30 minutes ago" },
];
...
export default function UsersManagement() {
    ...
    const handleSaveUser = () => {
        ...
        if (editUserId) {
            ...
            setUsers(users.map(u => u.id === editUserId ? { ...u, name: formData.name, email: formData.email } : u));
        } else {
            // Add new user
            const user = {
                id: users.length + 1,
                ...
                <div className="bg-white rounded-2xl border border-gray-100 shadow-sm overflow-hidden">
                    <table className="w-full">
                        <thead className="bg-gray-50 border-b border-gray-100">
                            <tr>
                                <th className="text-left px-6 py-4 text-xs font-semibold text-gray-600 uppercase tracking-wide">User</th>
                                <th className="text-left px-6 py-4 text-xs font-semibold text-gray-600 uppercase tracking-wide">Status</th>
                                <th className="text-left px-6 py-4 text-xs font-semibold text-gray-600 uppercase tracking-wide">Project</th>
                                <th className="text-left px-6 py-4 text-xs font-semibold text-gray-600 uppercase tracking-wide">Post</th>
                                <th className="text-left px-6 py-4 text-xs font-semibold text-gray-600 uppercase tracking-wide">Joined</th>
                                <th className="text-left px-6 py-4 text-xs font-semibold text-gray-600 uppercase tracking-wide">Actions</th>
                            </tr>
                        </thead>
                        <tbody className="divide-y divide-gray-100">
                            {filteredUsers.map((user) => (
                                <tr key={user.id} className="hover:bg-gray-50 transition-colors">
                                    ...
                                    <td className="px-6 py-4">
                                        <span className={`inline-block px-3 py-1 text-xs font-semibold rounded-full ${user.status === "Active" ? "bg-green-100 text-green-700" : "bg-gray-200 text-gray-600"
                                            }`}>
                                            {user.status}
                                        </span>
                                    </td>
                                    <td className="px-6 py-4 text-sm text-gray-700">{user.projects}</td>
                                    <td className="px-6 py-4 text-sm text-gray-700">{user.posts}</td>
                                    ...
                                    <td className="px-6 py-4 relative">
                                        ...
                                        {openDropdown === user.id && (
                                            <div className="absolute right-0 top-12 z-20 bg-white rounded-xl shadow-xl border border-gray-100 py-1 w-44">
                                                <button
                                                    onClick={() => { setSelectedUser(user); setOpenDropdown(null); }}
                    ...
                    <div className="bg-white rounded-2xl shadow-2xl max-w-2xl w-full max-h-[90vh] overflow-y-auto" onClick={(e) => e.stopPropagation()}>
                        ...
                        <div className="flex items-center gap-4 p-6 border-b border-gray-100">
                            ...
                            <div>
                                ...
                                <p className="text-sm text-gray-500">Complete user information and activity</p>
                            </div>
                        </div>
                        ...
                        <div className="p-6">
                            ...
                            <div className="flex items-start gap-6 mb-8">
                                ...
                                <div className="flex-1">
                                    <h3 className="text-xl font-bold text-gray-900 mb-3">{selectedUser.name}</h3>
                                ...
                                <div className="flex flex-col gap-2 min-w-[160px]">
                                    ...
                                    >
                                        <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth={2} className="w-4 h-4">
                                            <path strokeLinecap="round" strokeLinejoin="round" d="m16.862 4.487 1.687-1.688a1.875 1.875 0 1 1 2.652 2.652L6.832 19.82a4.5 4.5 0 0 1-1.897 1.13L2 21l.8-2.685a4.5 4.5 0 0 1 1.13-1.897l12.932-8.931Zm0 0L19.5 7.125M18 14v4.75A2.25 2.25 0 0 1 15.75 21H5.25A2.25 2.25 0 0 1 3 18.75V8.25A2.25 2.25 0 0 1 5.25 6H10" />
                                        </svg>
                                        Edit User
                                    </button>
                                    <button
                            ...
                            {/* Account Details */}
                            <div className="mb-8">
                                <h4 className="text-sm font-bold text-gray-900 mb-3">Account Details</h4>
                                <div className="bg-gray-50 rounded-lg p-4">
                                    <p className="text-xs text-gray-500 mb-1">Status</p>
                                    <span className={`inline-block px-3 py-1 text-xs font-semibold rounded-full ${selectedUser.status === "Active" ? "bg-green-100 text-green-700" : "bg-gray-200 text-gray-600"
                                        }`}>
                                        {selectedUser.status}
                                    </span>
                                </div>
                            ...
                            {/* Activity */}
                            <div>
                                <h4 className="text-sm font-bold text-gray-900 mb-4">Activity</h4>
                                <div className="grid grid-cols-2 gap-4">
                                    <div className="bg-blue-50 rounded-xl p-5 text-center">
                                        <p className="text-3xl font-bold text-blue-600 mb-1">{selectedUser.projects}</p>
                                        <p className="text-xs text-blue-600 font-medium">Gardens Created</p>
                                    </div>
                                    <div className="bg-green-50 rounded-xl p-5 text-center">
                                        <p className="text-3xl font-bold text-green-600 mb-1">{selectedUser.posts}</p>
                ...
                <div className="fixed inset-0 bg-black/40 backdrop-blur-sm z-50 flex items-center justify-center p-4" onClick={() => setIsModalOpen(false)}>
                    <div className="bg-white rounded-2xl shadow-2xl max-w-md w-full" onClick={(e) => e.stopPropagation()}>
                        ...
                        <div className="flex items-center justify-between p-6 border-b border-gray-100">
                            <div>
                                <h2 className="text-xl font-bold text-gray-900">{editUserId ? "Edit User" : "Add New User"}</h2>
                                <p className="text-sm text-gray-500 mt-1">{editUserId ? "Update user details" : "Create a new user account"}</p>
                            </div>
