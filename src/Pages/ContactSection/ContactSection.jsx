...
export default function ContactSection() {
  ...
  return (
    <section className="w-full bg-[#F8F8F8] py-20 pt-40 px-4 sm:px-6 lg:px-8 font-bricolage">
      <div className="max-w-5xl mx-auto">

        {/* ── Header ── */}
        <div className="text-center mb-14">
          <p className=" font-semibold uppercase text-[#3F6212] bg-[#3F6212]/10 py-2 px-5 inline rounded-full mb-3">
            Support &amp; Inquiries
          </p>
          <h2 className="text-4xl mt-4 md:text-5xl text-gray-900 mb-4">
            Get in{" "}
            <span className="text-[#3F6212]">Touch</span>
          </h2>
          <p className="text-gray-500 max-w-md mx-auto font-semibold leading-relaxed">
        ...
        <div>
          <div className="text-center mb-10">
            <h3 className="text-3xl text-gray-900 mb-2">Frequently Asked Questions</h3>
            <p className="text-gray-500 text-sm">Common questions from our community of gardeners.</p>
          </div>
